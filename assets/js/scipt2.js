...
/* SCRIVI QUI LA TUA RISPOSTA */
const { nome, cognome, città } = utenti[4];
console.log(nome);
console.log(cognome);
console.log(città);
...
/* SCRIVI QUI LA TUA RISPOSTA */
const numeri = [1, 2, 3];
const copyNumeri = [...numeri];
copyNumeri.push(99);
console.log(numeri);
console.log(copyNumeri);
...
/* SCRIVI QUI LA TUA RISPOSTA */
const utentiMaggiorenniMilano = utenti.filter(
  (utente) => utente.eta >= 18 && utente.città === "Milano",
);
console.log(utentiMaggiorenniMilano);
...
/* SCRIVI QUI LA TUA RISPOSTA */
const utente = utenti.find((a) => a.id === 4);
console.log(utente);
